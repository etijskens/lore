...
Module lore provides a unified interfaces executing OS commands LOcally (using 
the standard library's subprocess module) and REmotely over ssh (using the 
`paramiko <http://docs.paramiko.org>`_ package)

* lore.commands: wrappers of common bash commands, and methods to copy 
  between local and remote machines.
* lore.postprocessors: some functions to treat the output of a command on 
  stdout.
* lore.exceptions: exceptions used by lore.
"""
#===============================================================================    
__version__ = "2.1.0"
#===============================================================================    
